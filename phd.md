...
- 群ロボット（スウォーム、マルチロボットシステムとも）の研究をした。
  ...
  - 自分の場合は特に、どうやって人間が効果的に群ロボットを運用し、具体的に利点を感じられるタスクを実行させられるか、という点に興味があった。
  
### 社会人博士としての立場について<!-- omit in toc -->
- 入試は当然受けたが、勤め先からの視点で言えば「僕を大学院に派遣する」という形で入学した。
  - ポイントは「派遣した」という点で、僕の業務内容が「大学院での研究」に変わったという形になる。そのため、業務面・生活面の不安なく研究に集中することができた。職場には感謝してもしきれないし、少しでも恩返しができたらと思う。
- ただ、そういう恵まれた立場のため、社会人博士の生存戦略とか、どうすれば確実に学位が取れるかとか、そういう観点ではこの記事は参考にならないかもしれない。

### 研究に関するバックグラウンドなど<!-- omit in toc -->
- 修士までは再生医療の培養装置開発、就職後は研究プロジェクトの企画管理が主な業務。
- ロボットの研究となると厳密には博士課程で初めて手を付けたことになるが、そもそも就職後に取り扱う研究プロジェクトがロボット関係であり、企画管理だけでなく自分でロボットに触ることも推奨されていたので、素養の程度はともかくとして、違和感なく研究を始めることができた。
...
### 1年目後期（2021年度後半）<!-- omit in toc -->
  ...
  - 群の組織構造を作ってみないと仕方ないので、ヘンゼルとグレーテルでいうパンくず的に、通信中継ロボットを配置してツリー上の組織構造を形成する方式を作ってみた。
  - 作ったもの自体はシンプルなものだが、単独でも体裁は整いそうだったのでそのまま論文化を狙った。ロボット同士のネットワーク接続相手選定プロセスの簡素化とか、通信中継ロボットの選定や位置取りが分散的にできているかとか、そういった要素に主眼を置いた。
  - 群ロボットの組織図をBehavior Treeの階層構造に見立てる構想はうまいやり方が見つからず諦めかけていたが、ツリーというのだからせめて枝分かれのある組織構造を作ろうと思い、実装した。
### 2年目前期（2022年度前半）<!-- omit in toc -->
  - 組織構造の論文執筆をしつつ、枝分かれのある組織の形成についても国際学会投稿を狙う。後者が執筆の論理構築も実装の不具合解消もどちらも上手くいかず大変だった。論文は採択されるも、学会は非採択となった。
  - 今のところ、群は組織を形成するも、何か具体的なタスクをするわけではなくランダムウォークで彷徨うだけなので「次にどこに行くか？」を決める必要があるようなタスク設定が欲しくなり、何かの拍子にパトロール問題に出会う。
  - 
