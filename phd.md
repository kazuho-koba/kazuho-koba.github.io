...
- [前提的な話](#前提的な話)
- [研究の進み](#研究の進み)
- [博士課程で得られたものについて](#博士課程で得られたものについて)
...
- 最初はBehavior TreeとかそういうキャラクターAI的なものを拡張して、群のミッション管理システムのようなものを作ろうと思い、文献調査や学会聴講をした。
- 各ロボットそれぞれにキャラクターAIを載せるのでなく、Behavior Treeの階層構造を群ロボットの組織図に見立てて、総体として1つのキャラクターAIに基づいて行動するようなものを考えていた。
### 1年目後期（2021年度後半）<!-- omit in toc -->
- 前期に立てた構想が壮大過ぎて何をしたらいいかわからず途方に暮れる。
- 群の組織構造を作ってみないと仕方ないので、ヘンゼルとグレーテルのパンくずに準え、群ロボットが前進するのに合わせて通信中継ロボットを配置して、ツリー上のネットワーク構造（≒組織構造）を形成する方式を作ってみた。
...
- 作りかけでもストーリーがあれば発表できる自信がついたので、枝分かれのある組織の形成についても国際学会投稿を狙ったが、ストーリー構築も実装の不具合解消もどちらも上手くいかず大変だった。結局、学会も非採択となった。
- 採録された手法についても当時は、具体的なタスクはせずランダムウォークで彷徨うだけなので「どこに行くか？何をするか？」の意思決定を要求するタスク設定が欲しくなり、何かの拍子にパトロール問題に出会った。
...
- 各ロボットによるパトロールの実績を人間に伝える手法を考える過程で、組織構造を形成せずに分散的にパトロールをする手法も思いついた。ここは自分でも驚くくらいあっさり思いついたし、副次的に創発的な領域分担もできることがわかったりして面白かった。
### 2年目後期（2022年度後半）<!-- omit in toc -->
- 国際学会非採択になった枝分かれのある群組織構成について別の学会に出したところ、学会が提携する（？）論文誌への同時投稿を学会から勧められ、そのまま両方採録になった。ラッキーだったし、学位取得の面でもかなり有利な材料が揃った。
...
- 階層型組織構造とは別の、もっと分散的なパトロール問題や評価指標についても学会発表をする。発表自体は悪い意味でつつがなく終わってしまった感があった（質疑とかは盛り上がった）けど、それまで学会で会った人と再会したりして、少しずつ界隈に入っていく感覚を覚えた。顔を出し続けることが大事だと実感。
- 秋には博論の予備審査があるというので、とりあえず現時点の材料で仕上げた。
### 3年目後期（2023年度後半）<!-- omit in toc -->
- 博論の予備審査を無事にパスした。アルゴリズム開発という意味での成果はほぼできていたので、評価の観点でもう少し踏み込みたいなーと思っていた部分を本審査までの宿題と設定した。あと数か月でどこまでやれるか。
- 評価として、実際にパトロール中に発見した不審物の排除を人間の指示に基づいて実施する場合、パトロール自体の性能は劣るが人間の指示を受けやすいやり方と、パトロール自体の性能に勝るが人間の指示を受けるのに手間がかかるやり方で、性能に違いが出るのかどうか、という分析をした。タスクは単純なモデル化をしたのですぐに実装できたけど、これまでに作ったパトロールアルゴリズムとモデル化したタスクの統合は少し実装にてこずった。
- 論文投稿中だった階層型組織構造を形成・維持しながらパトロールする手法については、非採録となってしまった。非採録理由はもはや忘れてしまったけど。
- 博士課程で出した成果は全て公開するのが務めだと思っていたので慌てて再投稿先を探した。前回査読の指摘は修正しつつ、全ての問いに満額回答するために冗長になった部分を削って再投稿。博論本審査の準備、学会投稿2本と同じタイミングで、この論文誌再投稿も終わらせたのは僕にしては頑張ったと思うし、なんとか採録されてよかった。
- 階層組織構造ではなく、より分散的に各ロボットが散らばってパトロールするアルゴリズムについても同様に論文投稿をした。こちらも結局非採録→別の論文誌で採録となり、博士課程の成果はほぼすべて公開に漕ぎつけることができた。
- 博士論文の本審査は特に波乱も無くパスして、最終版の論文を事務局に収めた。本当は載せようと思っていた結果を載せ忘れたのが悔やまれる。
...
- よく言われるのはプレゼン能力とか語学力とか対人能力だと思う。別に間違ってはいないし、事実身についたと思っているが、別に仕事をしていても身についただろう。
- なんなら博士研究だとテーマによってはほぼ自分一人で完結してしまうこともある分、大きな組織間調整が確実について回る仕事の方がよほどタフな能力が身に着くと感じた。
- 博士課程自体は後輩にも勧められる経験だったと思うが、進学しなかった人が博士課程に行かなかった時間で遊び惚けているわけではあるまいし（別に遊び惚けていても良いのだが）、特に修士学生に進学を勧める場合は、就職に対する優位性として挙げるのはフェアではないと感じた。
...
- 他方、採録に際して非常に重要な立場を占める査読者は基本的に匿名で実施される。これには若干アンフェアさというか無責任さを感じた。
  ...
  - 査読自体が無責任に実施されているとは微塵も思わない。なんなら責任を負いすぎ（非常に大変な作業だと聞く）なまである。
- 引用についても同様で、誰かの論文の第2章で有象無象的に引用され、その回数に一喜一憂し、挙げ句その積み重ねで自分の生活の成否が決まるのか？と想像すると何とも言えない気分になる。
...
- 他方で、この業界に長くいるわけではない身からすると、無条件、あるいは少ない条件で、全ての組織に均等かつ潤沢に税金を原資とした予算を配分する理由があるかというと、そうではないと感じた。
  - 自分は今回の一件が無くとも6年間大学に所属して、まだ研究業界というものに馴染みがあるが、そうでない人からしたらどうだろうという話。
  - 「映える」材料は持っていないにせよ、持っていないなりに、市井の人に伝わるストーリー、ナラティブを総体として示していくのが重要だと思った。
